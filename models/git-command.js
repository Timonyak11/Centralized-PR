class GitCommand {
    ...
    status(){        
        ...
        */
        const objectlength = Object.keys(this.working_directory.new_changes).length;
        const keys = Object.keys(this.working_directory.new_changes);

        if(objectlength > 0){
            let result = 'You have ' + objectlength + ' change/s.';
